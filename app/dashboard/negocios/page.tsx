  ...
  return (
    <div className="w-full">
      ...
      <div className='flex flex-wrap items-center justify-center gap-4 mt-10'>
        ...
        <Link href={"/dashboard/negocios/create"} className='bg-blue-800 p-5 rounded-xl text-white w-[250px] h-[100px] text-center flex flex-col justify-center gap-2 items-center'>
