...
export default function ChartsGenerator({ threadId }: { threadId: any }) {
  ...
  const handleRetrieveThreadMessages = async (e: React.FormEvent) => {
    ...
    charts.innerHTML = responseBusinessResume;
  };
  ...
  return (
    <div className="mt-3">
      ...
      <form action={buildChartsInsights}>
        ...
        />
        <label htmlFor="costs_and_expenses_chart_insights">grafico de costos y gastos</label>
        <textarea 
        ...
        />
         <label htmlFor="net_profit_and_margins_chart_insights">grafico de utilidad neta y margen neto</label>
        <textarea 
        ...
        />
        <label htmlFor="detailed_expenses_chart_insights">grafico de costos desglosados</label>
        <textarea 
