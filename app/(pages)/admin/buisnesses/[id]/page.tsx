        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col mt-10">
                <div className="flex items-center justify-between mb-4">
                    <p className="text-2xl">Reportes de {company.name}</p>
                    <Link href={`/admin/buisnesses/${company.id}/create-report`} className="flex w-[220px] items-center gap-2 rounded-xl bg-blue-800 p-2 text-white">
