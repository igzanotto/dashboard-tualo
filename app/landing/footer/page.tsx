...
import Logo from '@/components/landing/components/Icons/Logo'
import '../globals.css'
...
export default function Footer (){
    return(
        <div className="bgFooter">
            <div className="flex items-center justify-around max-sm:flex-col max-sm:gap-8">
                <div className='flex items-center gap-2'>
                    <Logo/>
                    <p className='text-transparent max-sm:hidden'>tualooooi</p>
                </div>
                    
                <div className='flex flex-col items-center gap-2'>
                    <p className='font-semibold text-white text-lg'>Encuéntranos</p>
                    <div className='flex items-center gap-3'>
                        <Link href={"https://www.instagram.com/tualo.ai/"} target='_blank'>
                        ...
                        <Link href={"https://www.linkedin.com/company/tualo/"}>
                ...
                <div className='flex flex-col items-center gap-2'>
                    <p className='font-semibold text-white text-lg'>Contáctanos</p>
                    <div className='flex items-center gap-1'>
                        <Link className='flex items-center gap-1' href={`mailto:hola@tualo.mx`} title={`Enviar un correo electronico a hola@tualo.mx`} target="_blank" rel="noopener noreferrer">
                            ...
                            <p className='text-white'>hola@tualo.mx</p>
                        </Link>
                    </div>
                </div>
            </div>
            <div className='flex items-center justify-center gap-3 px-1 mt-10 pb-5 max-sm:flex-col'>
                <p className='text-slate-300 font-light text-sm'>©2024 Copywright Tualo</p>
                <p className='text-slate-300 font-light text-sm max-sm:hidden'>|</p>
                <p className='text-slate-300 font-light text-sm'>Políticas de privacidad</p>
                <p className='text-slate-300 font-light text-sm max-sm:hidden'>|</p>
                <p className='text-slate-300 font-light text-sm'>Términos y condiciones</p>
            </div>
        </div>
    )
}