...
export default async function CreateUserPage() {
  return (
    <form action={createUser} className='flex flex-col gap-4 w-[100%] p-6 bg-gray-100 rounded-xl'>
      ...
      <button type="submit" className='p-3 rounded-xl bg-blue-500 text-white mt-4'>Invitar usuario a negocio</button>
    </form>
  );
}
