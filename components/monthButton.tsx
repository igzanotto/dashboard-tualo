...
export function MonthButton({ reports }: MonthButtonProps) {
  ...
  return (
    <NavigationMenu>
      <NavigationMenuList>
        <NavigationMenuItem>
          <NavigationMenuTrigger className="bg-gradient-to-r from-[#4C30C5] to-[#39AEFF] text-white text-base hover:text-white capitalize"> {pathname === "/dashboard/reports" ? "Mes" : selectedMonth || "Mes"}</NavigationMenuTrigger>
